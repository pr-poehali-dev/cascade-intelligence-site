...
export interface Dict {
  ...
  footer: { rights: string; legal: string; hint: string; requisitesTitle: string; requisites: string[] };
}
...
export const TRANSLATIONS: Record<Lang, Dict> = {
  ru: {
    ...
    services: { tag: "Услуги", title: "НАПРАВЛЕНИЯ ДЕЯТЕЛЬНОСТИ", items: [
      ...
      { icon: "Shield", title: "Обеспечение безопасности", desc: "Личная охрана и сопровождение, поддержка в переговорах и кризисных ситуациях, защита бизнеса и имущества. Решаем задачи особой сложности — в том числе за пределами России, там, где другие отступают." },
      ...
      { icon: "Landmark", title: "Государственный сектор", desc: "Информационно-аналитическая поддержка государственных организаций, взаимодействие с профильными ведомствами, подготовка экспертных заключений и оценка рисков." },
      { icon: "Globe", title: "Международные организации", desc: "Информационно-аналитическое сопровождение международных миссий, оценка рисков и консультирование по вопросам безопасности в соответствии с нормами международного права." },
    ...
    steps: { tag: "Как мы работаем", title: "ВСЁ НАЧИНАЕТСЯ С ОДНОГО ЗВОНКА", items: [
      { icon: "Phone", title: "Свяжитесь с нами", desc: "Позвоните или напишите в Telegram. Опишите ситуацию в общих чертах — без лишних деталей." },
      { icon: "MessagesSquare", title: "Бесплатная консультация", desc: "Мы выслушаем, зададим уточняющие вопросы и оценим, чем можем помочь. Конфиденциально." },
      { icon: "ClipboardList", title: "План и условия", desc: "Предложим чёткий план действий, сроки и стоимость. Вы решаете, работать ли с нами." },
      { icon: "ShieldCheck", title: "Результат", desc: "Беремся за дело и доводим до результата. По завершении — документированный отчёт." },
    ] },
    ...
    contact: { tag: "Контакты", title: "СВЯЗАТЬСЯ С НАМИ", desc: "Все обращения обрабатываются конфиденциально. Круглосуточная линия для срочных ситуаций.", callBtn: "Позвонить", tgBtn: "Написать в Telegram", info: [ { icon: "Phone", label: "Телефон", value: "+7 913 364-57-48" }, { icon: "Send", label: "Telegram", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "База", value: "Москва · весь мир" }, { icon: "Clock", label: "Режим", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 ЧРК «Каскад». Все права защищены.", legal: "Деятельность осуществляется в рамках законодательства РФ.", hint: "Действуем строго в правовом поле РФ и международного права — предлагаем только законные решения.", requisitesTitle: "Реквизиты", requisites: ["Частная разведывательная компания «Каскад»", "Полные юридические реквизиты (наименование, ИНН, ОГРН) и лицензии предоставляются по запросу при заключении договора.", "Контакт: +7 913 364-57-48 · @PIC_STRUNA"] },
  },
  en: {
    ...
    services: { tag: "Services", title: "AREAS OF OPERATIONS", items: [
      ...
      { icon: "Shield", title: "Security", desc: "Personal protection and escort, support in negotiations and crisis situations, protection of business and property. We handle matters of exceptional complexity — including beyond Russia's borders, where others step back." },
      ...
      { icon: "Landmark", title: "Government Sector", desc: "Information and analytical support for government organizations, cooperation with relevant agencies, preparation of expert opinions and risk assessment." },
      { icon: "Globe", title: "International Organizations", desc: "Information and analytical support for international missions, risk assessment and security advisory in accordance with the norms of international law." },
    ...
    steps: { tag: "How we work", title: "IT ALL STARTS WITH ONE CALL", items: [
      { icon: "Phone", title: "Get in touch", desc: "Call us or message on Telegram. Describe the situation in general terms — no unnecessary details." },
      { icon: "MessagesSquare", title: "Free consultation", desc: "We listen, ask clarifying questions and assess how we can help. Confidentially." },
      { icon: "ClipboardList", title: "Plan and terms", desc: "We propose a clear plan of action, timeline and price. You decide whether to work with us." },
      { icon: "ShieldCheck", title: "Result", desc: "We take on the case and see it through. On completion — a documented report." },
    ] },
    ...
    cta: { title: "DON'T FACE IT ALONE", desc: "One call — and professionals take over your situation. The first consultation is free and absolutely confidential. The sooner you reach out, the more we can do.", callBtn: "Call", consultBtn: "Get a Consultation", tgBtn: "Message on Telegram", note: "Available 24/7 · Full anonymity guaranteed" },
    ...
    contact: { tag: "Contact", title: "GET IN TOUCH", desc: "All inquiries are handled confidentially. 24/7 line for urgent situations.", callBtn: "Call", tgBtn: "Message on Telegram", info: [ { icon: "Phone", label: "Phone", value: "+7 913 364-57-48" }, { icon: "Send", label: "Telegram", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "Base", value: "Moscow · worldwide" }, { icon: "Clock", label: "Hours", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 PIC «Cascade». All rights reserved.", legal: "Activity is conducted within the laws of the Russian Federation.", hint: "We act strictly within the legal framework of the RF and international law — offering only lawful solutions.", requisitesTitle: "Legal details", requisites: ["Private Intelligence Company «Cascade»", "Full legal details (company name, tax ID, registration number) and licenses are provided on request upon conclusion of a contract.", "Contact: +7 913 364-57-48 · @PIC_STRUNA"] },
  },
  fr: {
    ...
    services: { tag: "Services", title: "DOMAINES D'ACTIVITÉ", items: [
      ...
      { icon: "Shield", title: "Sécurité", desc: "Protection personnelle et accompagnement, soutien lors de négociations et de situations de crise, protection des entreprises et des biens. Nous traitons les affaires d'une complexité exceptionnelle — y compris au-delà des frontières de la Russie, là où d'autres reculent." },
      ...
      { icon: "Landmark", title: "Secteur public", desc: "Soutien informationnel et analytique aux organismes publics, coopération avec les administrations compétentes, préparation d'avis d'experts et évaluation des risques." },
      { icon: "Globe", title: "Organisations internationales", desc: "Accompagnement informationnel et analytique des missions internationales, évaluation des risques et conseil en matière de sécurité dans le respect des normes du droit international." },
    ...
    steps: { tag: "Comment nous travaillons", title: "TOUT COMMENCE PAR UN APPEL", items: [
      { icon: "Phone", title: "Contactez-nous", desc: "Appelez ou écrivez sur Telegram. Décrivez la situation dans les grandes lignes — sans détails superflus." },
      { icon: "MessagesSquare", title: "Consultation gratuite", desc: "Nous écoutons, posons des questions et évaluons comment vous aider. En toute confidentialité." },
      { icon: "ClipboardList", title: "Plan et conditions", desc: "Nous proposons un plan d'action clair, des délais et un prix. C'est vous qui décidez." },
      { icon: "ShieldCheck", title: "Résultat", desc: "Nous prenons l'affaire en main et allons jusqu'au bout. À la fin — un rapport documenté." },
    ] },
    ...
    contact: { tag: "Contact", title: "NOUS CONTACTER", desc: "Toutes les demandes sont traitées confidentiellement. Ligne 24h/24 pour les urgences.", callBtn: "Appeler", tgBtn: "Écrire sur Telegram", info: [ { icon: "Phone", label: "Téléphone", value: "+7 913 364-57-48" }, { icon: "Send", label: "Telegram", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "Base", value: "Moscou · monde entier" }, { icon: "Clock", label: "Horaires", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 CRP « Cascade ». Tous droits réservés.", legal: "L'activité est exercée dans le cadre de la législation de la Fédération de Russie.", hint: "Nous agissons strictement dans le cadre légal de la FR et du droit international — nous ne proposons que des solutions légales.", requisitesTitle: "Mentions légales", requisites: ["Compagnie privée de renseignement « Cascade »", "Les mentions légales complètes (dénomination, numéro fiscal, numéro d'enregistrement) et les licences sont fournies sur demande lors de la conclusion d'un contrat.", "Contact : +7 913 364-57-48 · @PIC_STRUNA"] },
  },
  ar: {
    ...
    services: { tag: "الخدمات", title: "مجالات النشاط", items: [
      ...
      { icon: "Shield", title: "تأمين الحماية", desc: "الحماية الشخصية والمرافقة، الدعم في المفاوضات والمواقف الحرجة، حماية الأعمال والممتلكات. نتولى المهام بالغة التعقيد — بما في ذلك خارج حدود روسيا، حيث يتراجع الآخرون." },
      { icon: "Eye", title: "استخبارات الأعمال", desc: "الاستخبارات التنافسية، تحليل OSINT، التحقق من الشركاء، كشف الفساد والاحتيال." },
      { icon: "Landmark", title: "القطاع الحكومي", desc: "الدعم المعلوماتي والتحليلي للمؤسسات الحكومية، والتعاون مع الجهات المختصة، وإعداد التقارير الخبيرة وتقييم المخاطر." },
      { icon: "Globe", title: "المنظمات الدولية", desc: "المرافقة المعلوماتية والتحليلية للمهام الدولية، وتقييم المخاطر وتقديم الاستشارات الأمنية وفقاً لقواعد القانون الدولي." },
    ...
    steps: { tag: "كيف نعمل", title: "كل شيء يبدأ بمكالمة واحدة", items: [
      { icon: "Phone", title: "تواصل معنا", desc: "اتصل أو راسلنا على تيليجرام. صِف الوضع بشكل عام — دون تفاصيل زائدة." },
      { icon: "MessagesSquare", title: "استشارة مجانية", desc: "نستمع، ونطرح أسئلة توضيحية، ونقيّم كيف يمكننا المساعدة. بسرية تامة." },
      { icon: "ClipboardList", title: "الخطة والشروط", desc: "نقترح خطة عمل واضحة ومدة وسعراً. أنت من يقرر التعامل معنا." },
      { icon: "ShieldCheck", title: "النتيجة", desc: "نتولى القضية وننجزها حتى النهاية. وعند الانتهاء — تقرير موثّق." },
    ] },
    ...
    cta: { title: "لا تواجه المشكلة وحدك", desc: "مكالمة واحدة — ويتولى المحترفون التعامل مع وضعك. الاستشارة الأولى مجانية وسرية تماماً. كلما تواصلت مبكراً، زادت قدرتنا على المساعدة.", callBtn: "اتصل", consultBtn: "احصل على استشارة", tgBtn: "راسلنا على تيليجرام", note: "متاحون على مدار الساعة · سرية تامة مضمونة" },
    ...
    contact: { tag: "اتصل بنا", title: "تواصل معنا", desc: "تُعالج جميع الطلبات بسرية. خط على مدار الساعة للحالات العاجلة.", callBtn: "اتصل", tgBtn: "راسلنا على تيليجرام", info: [ { icon: "Phone", label: "الهاتف", value: "+7 913 364-57-48" }, { icon: "Send", label: "تيليجرام", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "المقر", value: "موسكو · العالم" }, { icon: "Clock", label: "الدوام", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 شركة «كاسكاد». جميع الحقوق محفوظة.", legal: "يُمارَس النشاط ضمن تشريعات الاتحاد الروسي.", hint: "نعمل بشكل صارم ضمن الإطار القانوني للاتحاد الروسي والقانون الدولي — ولا نقدّم سوى حلول قانونية.", requisitesTitle: "البيانات القانونية", requisites: ["شركة الاستخبارات الخاصة «كاسكاد»", "تُقدَّم البيانات القانونية الكاملة (الاسم، الرقم الضريبي، رقم التسجيل) والتراخيص عند الطلب لدى إبرام العقد.", "للتواصل: ‎+7 913 364-57-48‎ · @PIC_STRUNA"] },
  },
  zh: {
    ...
    services: { tag: "服务", title: "业务领域", items: [
      ...
      { icon: "Shield", title: "安全保障", desc: "贴身保护与陪同、谈判及危机情境支援、企业与财产保护。我们承接极为复杂的任务——包括在俄罗斯境外、他人退缩之处。" },
      { icon: "Eye", title: "商业情报", desc: "竞争情报、OSINT 分析、合作伙伴核查、腐败与商业欺诈调查。" },
      { icon: "Landmark", title: "政府部门", desc: "为政府机构提供信息分析支持，与相关部门协作，编制专家意见并进行风险评估。" },
      { icon: "Globe", title: "国际组织", desc: "为国际任务提供信息分析支持，依据国际法准则进行风险评估并提供安全咨询。" },
    ...
    steps: { tag: "我们如何工作", title: "一切始于一通电话", items: [
      { icon: "Phone", title: "联系我们", desc: "致电或通过 Telegram 联系。大致描述您的情况——无需多余细节。" },
      { icon: "MessagesSquare", title: "免费咨询", desc: "我们倾听、提出澄清问题，并评估如何帮助您。全程保密。" },
      { icon: "ClipboardList", title: "方案与条款", desc: "我们提供清晰的行动方案、周期和价格。是否合作由您决定。" },
      { icon: "ShieldCheck", title: "结果", desc: "我们接手并全力做到底。完成后提供有据可查的报告。" },
    ] },
    ...
    contact: { tag: "联系", title: "联系我们", desc: "所有咨询均保密处理。紧急情况 24 小时专线。", callBtn: "致电", tgBtn: "通过 Telegram 联系", info: [ { icon: "Phone", label: "电话", value: "+7 913 364-57-48" }, { icon: "Send", label: "Telegram", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "基地", value: "莫斯科 · 全球" }, { icon: "Clock", label: "时间", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 「瀑布」私人情报公司。版权所有。", legal: "活动在俄罗斯联邦法律框架内开展。", hint: "我们严格在俄罗斯联邦及国际法的法律框架内行事——只提供合法的解决方案。", requisitesTitle: "法律信息", requisites: ["「瀑布」私人情报公司", "完整的法律信息（名称、税号、注册号）及许可证将在签订合同时应要求提供。", "联系方式：+7 913 364-57-48 · @PIC_STRUNA"] },
  },
  he: {
    ...
    services: { tag: "שירותים", title: "תחומי פעילות", items: [
      ...
      { icon: "Shield", title: "אבטחה", desc: "אבטחה אישית וליווי, תמיכה במשא ומתן ובמצבי משבר, הגנה על עסקים ורכוש. אנו מטפלים במשימות מורכבות במיוחד — לרבות מחוץ לגבולות רוסיה, היכן שאחרים נסוגים." },
      { icon: "Eye", title: "מודיעין עסקי", desc: "מודיעין תחרותי, ניתוח OSINT, בדיקת שותפים, חקירות שחיתות והונאה." },
      { icon: "Landmark", title: "המגזר הממשלתי", desc: "תמיכה מידעית ואנליטית לגופים ממשלתיים, שיתוף פעולה עם הרשויות המוסמכות, הכנת חוות דעת מומחים והערכת סיכונים." },
      { icon: "Globe", title: "ארגונים בינלאומיים", desc: "ליווי מידעי ואנליטי של משימות בינלאומיות, הערכת סיכונים וייעוץ בענייני אבטחה בהתאם לנורמות המשפט הבינלאומי." },
    ...
    steps: { tag: "איך אנחנו עובדים", title: "הכול מתחיל בשיחה אחת", items: [
      { icon: "Phone", title: "צרו קשר", desc: "התקשרו או כתבו בטלגרם. תארו את המצב באופן כללי — ללא פרטים מיותרים." },
      { icon: "MessagesSquare", title: "ייעוץ חינם", desc: "אנו מקשיבים, שואלים שאלות הבהרה ומעריכים כיצד נוכל לעזור. בחיסיון מלא." },
      { icon: "ClipboardList", title: "תוכנית ותנאים", desc: "נציע תוכנית פעולה ברורה, לוחות זמנים ומחיר. אתם מחליטים אם לעבוד איתנו." },
      { icon: "ShieldCheck", title: "תוצאה", desc: "אנו לוקחים את התיק ומביאים אותו לתוצאה. בסיום — דוח מתועד." },
    ] },
    ...
    contact: { tag: "צור קשר", title: "צרו קשר", desc: "כל הפניות מטופלות בחיסיון. קו חירום 24/7.", callBtn: "התקשרו", tgBtn: "כתבו בטלגרם", info: [ { icon: "Phone", label: "טלפון", value: "+7 913 364-57-48" }, { icon: "Send", label: "טלגרם", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "בסיס", value: "מוסקבה · העולם" }, { icon: "Clock", label: "שעות", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 חברת «קסקאד». כל הזכויות שמורות.", legal: "הפעילות מתבצעת במסגרת חוקי הפדרציה הרוסית.", hint: "אנו פועלים אך ורק במסגרת החוקית של הפדרציה הרוסית והמשפט הבינלאומי — ומציעים פתרונות חוקיים בלבד.", requisitesTitle: "פרטים משפטיים", requisites: ["חברת מודיעין פרטית «קסקאד»", "פרטים משפטיים מלאים (שם, מספר עוסק, מספר רישום) ורישיונות יימסרו לפי בקשה בעת חתימת חוזה.", "ליצירת קשר: ‎+7 913 364-57-48‎ · @PIC_STRUNA"] },
  },
  ja: {
    ...
    services: { tag: "サービス", title: "活動分野", items: [
      ...
      { icon: "Shield", title: "セキュリティ", desc: "身辺警護・同行、交渉や危機的状況でのサポート、事業や財産の保護。極めて困難な案件にも対応します——ロシア国外、他者が退く場所においても。" },
      { icon: "Eye", title: "ビジネス諜報", desc: "競合調査、OSINT分析、取引先の確認、汚職・企業不正の調査。" },
      { icon: "Landmark", title: "政府部門", desc: "政府機関への情報分析支援、関係省庁との連携、専門的な意見書の作成およびリスク評価。" },
      { icon: "Globe", title: "国際機関", desc: "国際ミッションへの情報分析支援、リスク評価、そして国際法の規範に基づく安全保障に関する助言。" },
    ...
    steps: { tag: "ご依頼の流れ", title: "すべては一本の電話から", items: [
      { icon: "Phone", title: "ご連絡ください", desc: "お電話または Telegram で。状況を大まかにお伝えください——余計な詳細は不要です。" },
      { icon: "MessagesSquare", title: "無料相談", desc: "お話を伺い、確認の質問をし、どうお役に立てるか見極めます。機密厳守で。" },
      { icon: "ClipboardList", title: "計画と条件", desc: "明確な行動計画、期間、料金をご提案します。ご依頼になるかはお客様が決めます。" },
      { icon: "ShieldCheck", title: "結果", desc: "案件をお引き受けし、結果まで導きます。完了時には記録された報告書をお渡しします。" },
    ] },
    ...
    cta: { title: "一人で抱え込まないでください", desc: "一本の電話で——専門家があなたの状況を引き受けます。初回相談は無料、完全機密。早くご連絡いただくほど、できることが増えます。", callBtn: "電話する", consultBtn: "相談する", tgBtn: "Telegramで連絡", note: "24時間対応 · 完全な匿名性を保証" },
    ...
    contact: { tag: "連絡先", title: "お問い合わせ", desc: "すべてのお問い合わせは機密として扱われます。緊急時は24時間対応。", callBtn: "電話する", tgBtn: "Telegramで連絡", info: [ { icon: "Phone", label: "電話", value: "+7 913 364-57-48" }, { icon: "Send", label: "Telegram", value: "@PIC_STRUNA" }, { icon: "MapPin", label: "拠点", value: "モスクワ · 全世界" }, { icon: "Clock", label: "対応時間", value: "24 / 7" } ] },
    footer: { rights: "© 2015–2026 民間諜報会社「カスケード」。無断転載禁止。", legal: "活動はロシア連邦法の枠内で行われます。", hint: "私たちはロシア連邦法および国際法の枠内で厳格に活動し——合法な解決策のみをご提案します。", requisitesTitle: "法的情報", requisites: ["民間諜報会社「カスケード」", "完全な法的情報（名称・納税者番号・登録番号）およびライセンスは、契約締結時にご要望に応じて提供いたします。", "連絡先：+7 913 364-57-48 · @PIC_STRUNA"] },
  },
};