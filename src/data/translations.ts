...
export const TRANSLATIONS: Record<Lang, Dict> = {
  ru: {
    ...
    footer: { rights: "© 2024 ЧРК «Каскад». Все права защищены.", legal: "Лицензированная деятельность в рамках законодательства РФ.", hint: "Действуем в правовом поле РФ и международного права — находя законную форму для любой задачи." },
  },
  en: {
    ...
    footer: { rights: "© 2024 PIC «Cascade». All rights reserved.", legal: "Licensed activity within the laws of the Russian Federation.", hint: "Operating within RF and international law — finding a lawful form for any task." },
  },
  fr: {
    ...
    footer: { rights: "© 2024 CRP « Cascade ». Tous droits réservés.", legal: "Activité licenciée conforme à la législation de la Fédération de Russie.", hint: "Nous agissons dans le cadre du droit russe et international — en trouvant une forme légale pour chaque mission." },
  },
  ar: {
    ...
    footer: { rights: "© 2024 شركة «كاسكاد». جميع الحقوق محفوظة.", legal: "نشاط مرخّص ضمن تشريعات الاتحاد الروسي.", hint: "نعمل ضمن القانون الروسي والدولي — مع إيجاد صيغة قانونية لكل مهمة." },
  },
  zh: {
    ...
    footer: { rights: "© 2024 「瀑布」私人情报公司。版权所有。", legal: "在俄罗斯联邦法律框架内的持牌活动。", hint: "我们在俄罗斯及国际法框架内行事——为每项任务找到合法的形式。" },
  },
  he: {
    ...
    footer: { rights: "© 2024 חברת «קסקאד». כל הזכויות שמורות.", legal: "פעילות מורשית במסגרת חוקי הפדרציה הרוסית.", hint: "אנו פועלים במסגרת החוק הרוסי והבינלאומי — תוך מציאת צורה חוקית לכל משימה." },
  },
  ja: {
    ...
    footer: { rights: "© 2024 民間諜報会社「カスケード」。無断転載禁止。", legal: "ロシア連邦法に基づく認可された活動。", hint: "ロシア連邦法および国際法の枠内で——あらゆる任務に合法的な形を見出します。" },
  },
};