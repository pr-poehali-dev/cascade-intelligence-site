...
export const TRANSLATIONS: Record<Lang, Dict> = {
  ru: {
    ...
    agent: { tag: "Сотрудничество", title: "СОТРУДНИЧЕСТВО", desc: "Мы открыты к сотрудничеству с надёжными людьми по всему миру. Если у вас есть опыт, знания или возможности, которыми вы готовы поделиться — оставьте заявку. Мы свяжемся с вами и обсудим формат.", fields: { alias: "Как к вам обращаться", contact: "Удобный способ связи", skills: "Ваш опыт и сфера интересов", motivation: "Почему вам интересно сотрудничество", btn: "Отправить заявку" }, consent: "Я подаю заявку добровольно и осознанно", sent: "ЗАЯВКА ПРИНЯТА", sentDesc: "Спасибо за интерес к сотрудничеству. Мы свяжемся с вами через указанный способ связи." },
  ...
  en: {
    ...
    agent: { tag: "Cooperation", title: "COOPERATION", desc: "We are open to working with reliable people around the world. If you have experience, knowledge or opportunities you are willing to share — submit a request. We will get in touch and discuss the format.", fields: { alias: "How to address you", contact: "Convenient contact method", skills: "Your experience and area of interest", motivation: "Why cooperation interests you", btn: "Submit Request" }, consent: "I submit this request voluntarily and knowingly", sent: "REQUEST RECEIVED", sentDesc: "Thank you for your interest in cooperation. We will contact you via the method you provided." },
  ...
  fr: {
    ...
    agent: { tag: "Coopération", title: "COOPÉRATION", desc: "Nous sommes ouverts à la coopération avec des personnes fiables partout dans le monde. Si vous avez une expérience, des connaissances ou des possibilités à partager — envoyez une demande. Nous vous contacterons pour en discuter.", fields: { alias: "Comment vous appeler", contact: "Moyen de contact pratique", skills: "Votre expérience et domaine d'intérêt", motivation: "Pourquoi la coopération vous intéresse", btn: "Envoyer la demande" }, consent: "Je soumets cette demande volontairement et en connaissance de cause", sent: "DEMANDE REÇUE", sentDesc: "Merci de votre intérêt pour la coopération. Nous vous contacterons via le moyen indiqué." },
  ...
  ar: {
    ...
    agent: { tag: "تعاون", title: "تعاون", desc: "نحن منفتحون على التعاون مع أشخاص موثوقين حول العالم. إذا كانت لديك خبرة أو معرفة أو إمكانات ترغب في مشاركتها — أرسل طلباً. سنتواصل معك لمناقشة الصيغة.", fields: { alias: "كيف نخاطبك", contact: "وسيلة تواصل مناسبة", skills: "خبرتك ومجال اهتمامك", motivation: "لماذا يهمك التعاون" , btn: "إرسال الطلب" }, consent: "أقدّم هذا الطلب طوعاً وعن دراية", sent: "تم استلام الطلب", sentDesc: "شكراً لاهتمامك بالتعاون. سنتواصل معك عبر وسيلة الاتصال التي حددتها." },
  ...
  zh: {
    ...
    agent: { tag: "合作", title: "合作", desc: "我们乐于与世界各地可靠的人士合作。如果您拥有愿意分享的经验、知识或资源——请提交申请，我们会与您联系并商讨合作形式。", fields: { alias: "如何称呼您", contact: "方便的联系方式", skills: "您的经验与兴趣领域", motivation: "您为何对合作感兴趣", btn: "提交申请" }, consent: "我自愿且知情地提交此申请", sent: "申请已接收", sentDesc: "感谢您对合作的兴趣。我们将通过您提供的方式与您联系。" },
  ...
  he: {
    ...
    agent: { tag: "שיתוף פעולה", title: "שיתוף פעולה", desc: "אנו פתוחים לשיתוף פעולה עם אנשים אמינים בכל העולם. אם יש לך ניסיון, ידע או יכולות שאתה מוכן לשתף — שלח בקשה. ניצור איתך קשר ונשוחח על הפורמט.", fields: { alias: "כיצד לפנות אליך", contact: "אמצעי קשר נוח", skills: "הניסיון ותחום העניין שלך", motivation: "מדוע שיתוף הפעולה מעניין אותך", btn: "שליחת בקשה" }, consent: "אני מגיש בקשה זו מרצוני ומתוך מודעות", sent: "הבקשה התקבלה", sentDesc: "תודה על התעניינותך בשיתוף פעולה. ניצור איתך קשר באמצעי שציינת." },
  ...
  ja: {
    ...
    agent: { tag: "協力", title: "協力", desc: "私たちは世界中の信頼できる方々との協力を歓迎しています。共有していただける経験・知識・可能性があれば——お申し込みください。こちらからご連絡し、協力の形について相談いたします。", fields: { alias: "お呼びする名前", contact: "ご都合のよい連絡手段", skills: "ご経験と関心分野", motivation: "協力に関心を持たれた理由", btn: "申し込む" }, consent: "私は自発的かつ理解の上でこの申し込みを行います", sent: "申し込みを受領しました", sentDesc: "ご関心をお寄せいただきありがとうございます。ご指定の手段でご連絡いたします。" },
