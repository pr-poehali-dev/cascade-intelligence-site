...
export const TRANSLATIONS: Record<Lang, Dict> = {
  ru: {
    ...
    services: { tag: "Услуги", title: "НАПРАВЛЕНИЯ ДЕЯТЕЛЬНОСТИ", items: [
      ...
      { icon: "Globe", title: "Международные организации", desc: "Сопровождение международных миссий и оперативная поддержка в зонах конфликтов, включая активные действия на местности. Аналитические доклады, оценка рисков и присутствие там, где это необходимо." },
  ...
  en: {
    ...
    services: { tag: "Services", title: "AREAS OF OPERATIONS", items: [
      ...
      { icon: "Globe", title: "International Organizations", desc: "Support for international missions and operational backup in conflict zones, including active field action. Analytical reports, risk assessment and presence wherever it is required." },
  ...
  fr: {
    ...
    services: { tag: "Services", title: "DOMAINES D'ACTIVITÉ", items: [
      ...
      { icon: "Globe", title: "Organisations internationales", desc: "Soutien aux missions internationales et appui opérationnel en zones de conflit, y compris une action active sur le terrain. Rapports analytiques, évaluation des risques et présence partout où elle est requise." },
  ...
  ar: {
    ...
    services: { tag: "الخدمات", title: "مجالات النشاط", items: [
      ...
      { icon: "Globe", title: "المنظمات الدولية", desc: "دعم المهام الدولية والإسناد الميداني في مناطق النزاع، بما في ذلك العمل الفعّال على الأرض. تقارير تحليلية وتقييم للمخاطر وحضور أينما لزم الأمر." },
    ...
    agent: { tag: "تعاون", title: "كن جزءاً من الفريق", desc: "نبحث عن أصحاب الفعل حول العالم — من يمتلكون وصولاً أو معلومات أو مهارات خاصة، أو يرغبون ببساطة في أن يكونوا نافعين لقضية كبرى. الخبرة العسكرية والميدانية، ومعرفة الأوساط المغلقة، والصلات في الدوائر المناسبة — كل ذلك مُقدَّر. لكلٍّ دوره. هذا ليس عملاً مقابل المال، بل إسهام في قضية أكبر منّا. اتخذ الخطوة الأولى — ونحن نتكفّل بالباقي.", secure: "تُشفَّر جميع البيانات بخوارزمية AES-256 مباشرة في متصفحك. لا نحفظ عنوان IP أو البيانات الوصفية. هويتك محمية بالكامل — التواصل معنا آمن.", fields: { alias: "كيف نخاطبك", contact: "وسيلة تواصل آمنة", skills: "خبرتك، وصولك، منطقتك وإمكاناتك", motivation: "كيف يمكنك أن تكون نافعاً" , btn: "إرسال الطلب" }, consent: "أنا مستعد للمساهمة على أساس تطوعي وبدون مقابل", sent: "تم استلام الطلب", sentDesc: "ستتم دراسة إمكاناتك. إن كنت مناسباً — سنتواصل معك عبر القناة المحددة. تصرّف بتكتم." },
  ...
  zh: {
    ...
    services: { tag: "服务", title: "业务领域", items: [
      ...
      { icon: "Globe", title: "国际组织", desc: "支持国际任务、在冲突地区提供行动支援，包括实地积极行动。分析报告、风险评估，以及在任何需要之处的存在。" },
    ...
    report: { tag: "匿名通道", title: "举报犯罪或恐怖活动", warning: "信息在您的浏览器中以 AES-256 直接加密。不保存 IP 地址和元数据。来源完全匿名。", categories: ["恐怖主义与极端主义", "严重犯罪", "腐败与欺诈", "通缉人员信息", "国家安全威胁", "其他"], form: { category: "信息类别", region: "地区 / 国家", message: "详细描述（至少 50 个字符）", btn: "匿名发送", hint: "如需保持匿名，请勿填写个人信息" }, encrypting: "AES-256 加密中...", sent: "信息已加密并发送", sentDesc: "您的举报 ID 已销毁。会话匿名。数据已转交行动人员。", error: "发送失败 — 请检查网络连接后重试。如仍无法发送，请致电或通过 Telegram 联系我们。" },
    ...
    agent: { tag: "合作", title: "成为团队的一员", desc: "我们在全球寻找行动派——拥有渠道、信息、特殊技能，或只是愿意为伟大事业尽一份力的人。军事与行动经验、对封闭领域的了解、在关键圈层的人脉——这些都备受重视。每个人都有自己的角色。这不是为钱工作，而是为比我们更宏大的事业贡献力量。迈出第一步——其余交给我们。", secure: "所有数据均在您的浏览器中以 AES-256 直接加密。我们不保存您的 IP 地址和元数据。您的匿名性受到完全保护——联系我们是安全的。", fields: { alias: "如何称呼您", contact: "安全的联系方式", skills: "您的经验、渠道、所在地区与能力", motivation: "您能提供怎样的帮助", btn: "提交申请" }, consent: "我愿意以自愿且无偿的方式提供协助", sent: "申请已接收", sentDesc: "我们将评估您的潜力。若您合适，将通过指定渠道与您联系。请保持低调。" },
  ...
  he: {
    ...
    services: { tag: "שירותים", title: "תחומי פעילות", items: [
      ...
      { icon: "Globe", title: "ארגונים בינלאומיים", desc: "תמיכה במשימות בינלאומיות וסיוע מבצעי באזורי סכסוך, לרבות פעולה אקטיבית בשטח. דוחות אנליטיים, הערכת סיכונים ונוכחות בכל מקום שבו היא נדרשת." },
  ...
  ja: {
    ...
    services: { tag: "サービス", title: "活動分野", items: [
      ...
      { icon: "Globe", title: "国際機関", desc: "国際ミッションの支援、紛争地域での作戦支援（現地での積極的な行動を含む）。分析報告、リスク評価、そして必要とされる場所での存在。" },
    ...
    agent: { tag: "協力", title: "チームの一員になる", desc: "私たちは世界中で「行動する人」を求めています——アクセス、情報、特別な技能をお持ちの方、あるいは大いなる目的に役立ちたいと願う方へ。軍事・作戦の経験、閉ざされた領域への知見、適切な人脈——そのすべてが評価されます。誰にでも役割があります。これは金銭のための仕事ではなく、私たち自身より大きな目的への貢献です。最初の一歩を——あとは私たちが引き受けます。", secure: "すべてのデータはお使いのブラウザ内で直接 AES-256 により暗号化されます。IPアドレスやメタデータは保存しません。あなたの匿名性は完全に守られます——私たちへの連絡は安全です。", fields: { alias: "お呼びする名前", contact: "安全な連絡手段", skills: "ご経験、アクセス、地域、可能性", motivation: "どのように役立てるか", btn: "申し込む" }, consent: "私は自発的かつ無報酬で協力する用意があります", sent: "申し込みを受領しました", sentDesc: "あなたの可能性を検討します。適任であれば、指定の経路でご連絡します。慎重に行動してください。" },
