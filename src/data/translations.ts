...
export interface Dict {
  ...
  globe: { detecting: string; detected: string; denied: string; locate: string; lat: string; lon: string; tracked: string };
  report: {
...
export const TRANSLATIONS: Record<Lang, Dict> = {
  ru: {
    ...
    globe: { detecting: "Определение координат...", detected: "Вы в зоне нашего присутствия", denied: "Координаты не определены", locate: "Определить моё местоположение", lat: "Широта", lon: "Долгота", tracked: "Сигнал получен · Объект на карте" },
  ...
  en: {
    ...
    globe: { detecting: "Detecting coordinates...", detected: "You are within our area of presence", denied: "Coordinates not determined", locate: "Detect my location", lat: "Latitude", lon: "Longitude", tracked: "Signal received · Target on map" },
  ...
  fr: {
    ...
    globe: { detecting: "Détection des coordonnées...", detected: "Vous êtes dans notre zone de présence", denied: "Coordonnées non déterminées", locate: "Détecter ma position", lat: "Latitude", lon: "Longitude", tracked: "Signal reçu · Cible sur la carte" },
  ...
  ar: {
    ...
    globe: { detecting: "...جارٍ تحديد الإحداثيات", detected: "أنت ضمن نطاق حضورنا", denied: "لم يتم تحديد الإحداثيات", locate: "حدّد موقعي", lat: "خط العرض", lon: "خط الطول", tracked: "تم استقبال الإشارة · الهدف على الخريطة" },
  ...
  zh: {
    ...
    globe: { detecting: "正在确定坐标...", detected: "您处于我们的覆盖范围内", denied: "未能确定坐标", locate: "定位我的位置", lat: "纬度", lon: "经度", tracked: "已接收信号 · 目标已在地图上" },
  ...
  he: {
    ...
    globe: { detecting: "...מאתר קואורדינטות", detected: "אתה בתחום הנוכחות שלנו", denied: "הקואורדינטות לא זוהו", locate: "אתר את מיקומי", lat: "קו רוחב", lon: "קו אורך", tracked: "האות התקבל · המטרה על המפה" },
  ...
  ja: {
    ...
    globe: { detecting: "座標を特定中...", detected: "あなたは当社の活動圏内にいます", denied: "座標を特定できませんでした", locate: "現在地を特定", lat: "緯度", lon: "経度", tracked: "信号を受信 · 対象を地図に表示" },
